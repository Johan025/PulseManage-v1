      ...
      <div className="main-container">
        <div className="sidebar-wrapper" id="sidebar">
               ...
               <div className="sidebar_content text-start">
                   <ul className="te">
                      <li className="active"><FontAwesomeIcon icon={faGauge} className="icon" /> <h1> Dashboard</h1></li>
                      <li><FontAwesomeIcon icon={faUsers} className="icon" /> <h1>Liste employés</h1></li>
                      <li><FontAwesomeIcon icon={faPlus} className="icon" /> <h1>Ajouter des employés</h1></li>
                      <li><FontAwesomeIcon icon={faBox} className="icon" /> <h1>Gestion de Stocks</h1></li>
                      <li><FontAwesomeIcon icon={faBullhorn} className="icon" /> <h1>Annonces</h1></li>
                      <li><FontAwesomeIcon icon={faCalendar} className="icon" /> <h1>Emplois du temps</h1></li>
                      <li></li>
                   </ul>
